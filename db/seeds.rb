...
ApplicationRecord.transaction do 
    ...
    pin1 = Pin.create!(creator_id: user1.id, description: 'testing', title: 'testing', link: "testing", board_id: null);

    pin2 = Pin.create!(creator_id: user3.id, description: 'Nectarine summer salad', title: 'Nectarine summer salad', link: 'https://honestlyyum.com/11034/summer-nectarine-salad/', board_id: null);
    ...
    pin3 = Pin.create!(creator_id: user2.id, description: 'flan recipe', title: 'Creamy caramel flan', link: 'https://www.tasteofhome.com/recipes/creamy-caramel-flan/', board_id: null);
    ...
    pin4 = Pin.create!(creator_id: user2.id, description: 'caramel lattes for the fall', title: 'Caramel latte recipe', link: 'https://bakingmischief.com/easy-caramel-latte/', board_id: null);
    ...
    pin8 = Pin.create!(creator_id: user3.id, description: 'Love matcha and yuzu together...and combine it with gin!', title: 'Matcha Yuzu Gin Fizz', link: 'https://www.siftandsimmer.com/matcha-yuzu-gin-fizz/', board_id: null);
    ...
    pin9 = Pin.create!(creator_id: user3.id, description: '', title: 'Greek salad', link: 'https://downshiftology.com/recipes/greek-salad/', board_id: null);
    ...
    pin10 = Pin.create!(creator_id: user3.id, description: 'Vanilla lavender syrup to make lavender lattes!', title: 'Vanilla Lavender Syrup', link: 'https://www.lifewithtuyen.com/post/vanilla-lavender-syrup', board_id: null);
    ...
    pin11 = Pin.create!(creator_id: user3.id, description: 'celebrate spring with blackberry lavender scones', title: 'Blackberry Lavender White Chocolate Scones', link: 'https://www.halfbakedharvest.com/blackberry-lavender-white-chocolate-scones/', board_id: null);
    ...
    pin12 = Pin.create!(creator_id: user3.id, description: 'Lemon garlic baked chicken thighs - a delicious and simple main dish', title: 'Lemon Garlic Baked Chicken Thighs', link: 'https://www.eatwell101.com/garlic-lemon-baked-chicken-thighs-recipe', board_id: null);
    ...
    pin15 = Pin.create!(creator_id: user2.id, description: '', title: 'Salted caramel chocolate chip cookie bars', link: 'https://thatovenfeelin.com/salted-caramel-chocolate-chip-cookie-bars', board_id: null);
    ...
    pin16 = Pin.create!(creator_id: user2.id, description: 'California casual kitchen', title: 'california casual kitchen', link: 'https://thehavenlist.com/this-warm-minimalist-kitchen-is-california-casual-at-its-finest/', board_id: null);
    ...
    pin17 = Pin.create!(creator_id: user2.id, description: 'Camillestyles.com: Lauren Conrad’s Home Is the Definition of California Cool', title: 'california cool home', link: 'https://camillestyles.com/design/lauren-conrads-home-is-the-definition-of-california-cool/', board_id: null);
    ...
    pin19 = Pin.create!(creator_id: user2.id, description: '41 Coastal Living Room Design Ideas You Havent Seen Before: Image 34 / 41', title: '41 Coastal Living Room Design Ideas', link: 'https://edwardgeorgelondon.com/en-usa/blogs/home-garden/coastal-living-room-design-ideas', board_id: null);
    ...
    pin20 = Pin.create!(creator_id: user2.id, description: 'modern coastal home with neutral palette', title: 'Modern coastal home', link: 'https://www.homestolove.com.au/home-tours/modern-coastal-home-with-neutral-palette-21808/', board_id: null);
    ...
    pin21 = Pin.create!(creator_id: user2.id, description: 'From crate and barrel: tate dining table', title: 'modern dining room', link: 'https://www.crateandbarrel.com/tate-78-114-walnut-extendable-mid-century-dining-table/s683452', board_id: null);
