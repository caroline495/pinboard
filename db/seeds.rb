...
ApplicationRecord.transaction do 
    ...
    board2 = Board.create!(creator_id: user1.id, description: 'ilnp spring collection', name: 'Testing', private_mode: false)
    ...
    board8 = Board.create!(creator_id: user2.id, description: '', name: 'home - california casual', private_mode: false)

    pin1 = Pin.create!(creator_id: user1.id, description: 'testing', title: 'testing', link: "testing", board_id: board2.id);

    pin2 = Pin.create!(creator_id: user3.id, description: 'Nectarine summer salad', title: 'Nectarine summer salad', link: 'https://honestlyyum.com/11034/summer-nectarine-salad/', board_id: board1.id);
    ...
    pin3 = Pin.create!(creator_id: user2.id, description: 'flan recipe', title: 'Creamy caramel flan', link: 'https://www.tasteofhome.com/recipes/creamy-caramel-flan/', board_id: board6.id);
    ...
    pin4 = Pin.create!(creator_id: user2.id, description: 'caramel lattes for the fall', title: 'Caramel latte recipe', link: 'https://bakingmischief.com/easy-caramel-latte/', board_id: board7.id);
    ...
    pin8 = Pin.create!(creator_id: user3.id, description: 'Love matcha and yuzu together...and combine it with gin!', title: 'Matcha Yuzu Gin Fizz', link: 'https://www.siftandsimmer.com/matcha-yuzu-gin-fizz/', board_id: board2.id);
    ...
    pin9 = Pin.create!(creator_id: user3.id, description: '', title: 'Greek salad', link: 'https://downshiftology.com/recipes/greek-salad/', board_id: board1.id);
    ...
    pin10 = Pin.create!(creator_id: user3.id, description: 'Vanilla lavender syrup to make lavender lattes!', title: 'Vanilla Lavender Syrup', link: 'https://www.lifewithtuyen.com/post/vanilla-lavender-syrup', board_id: board7.id);
    ...
    pin11 = Pin.create!(creator_id: user3.id, description: 'celebrate spring with blackberry lavender scones', title: 'Blackberry Lavender White Chocolate Scones', link: 'https://www.halfbakedharvest.com/blackberry-lavender-white-chocolate-scones/', board_id: board6.id);
    ...
    pin12 = Pin.create!(creator_id: user3.id, description: 'Lemon garlic baked chicken thighs - a delicious and simple main dish', title: 'Lemon Garlic Baked Chicken Thighs', link: 'https://www.eatwell101.com/garlic-lemon-baked-chicken-thighs-recipe', board_id: board1.id);
    ...
    pin15 = Pin.create!(creator_id: user2.id, description: '', title: 'Salted caramel chocolate chip cookie bars', link: 'https://thatovenfeelin.com/salted-caramel-chocolate-chip-cookie-bars', board_id: board6.id);
    ...
    pin16 = Pin.create!(creator_id: user2.id, description: 'California casual kitchen', title: 'california casual kitchen', link: 'https://thehavenlist.com/this-warm-minimalist-kitchen-is-california-casual-at-its-finest/', board_id: board8.id);
    ...
    pin17 = Pin.create!(creator_id: user2.id, description: 'Camillestyles.com: Lauren Conrad’s Home Is the Definition of California Cool', title: 'california cool home', link: 'https://camillestyles.com/design/lauren-conrads-home-is-the-definition-of-california-cool/', board_id: board8.id);
    ...
    pin19 = Pin.create!(creator_id: user2.id, description: '41 Coastal Living Room Design Ideas You Havent Seen Before: Image 34 / 41', title: '41 Coastal Living Room Design Ideas', link: 'https://edwardgeorgelondon.com/en-usa/blogs/home-garden/coastal-living-room-design-ideas', board_id: board8.id);
    ...
    pin20 = Pin.create!(creator_id: user2.id, description: 'modern coastal home with neutral palette', title: 'Modern coastal home', link: 'https://www.homestolove.com.au/home-tours/modern-coastal-home-with-neutral-palette-21808/', board_id: board8.id);
    ...
    pin21 = Pin.create!(creator_id: user2.id, description: 'From crate and barrel: tate dining table', title: 'modern dining room', link: 'https://www.crateandbarrel.com/tate-78-114-walnut-extendable-mid-century-dining-table/s683452', board_id: board8.id);
